...
--   				@area_id@ the @RID@ of the other Area2D's @CollisionObject2D@ used by the @PhysicsServer2D@.
--   				@area@ the other Area2D.
--   				@area_shape@ the index of the @Shape2D@ of the other Area2D used by the @PhysicsServer2D@.
--   				@local_shape@ the index of the @Shape2D@ of this Area2D used by the @PhysicsServer2D@.
...
--   				@body_id@ the @RID@ of the @PhysicsBody2D@ or @TileSet@'s @CollisionObject2D@ used by the @PhysicsServer2D@.
--   				@body@ the @Node@, if it exists in the tree, of the @PhysicsBody2D@ or @TileMap@.
--   				@body_shape@ the index of the @Shape2D@ of the @PhysicsBody2D@ or @TileMap@ used by the @PhysicsServer2D@.
--   				@local_shape@ the index of the @Shape2D@ of this Area2D used by the @PhysicsServer2D@.
